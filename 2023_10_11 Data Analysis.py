...
light_profile = pd.read_excel("2023_10_10_light_profile.xlsx", engine = "openpyxl")
...
'loading data'
df2raw = pd.read_excel("2023_10_10_Filter_2.xlsx", engine = "openpyxl", skiprows = 1)
df4raw = pd.read_excel("2023_10_10_Filter_4.xlsx", engine = "openpyxl", skiprows = 1)
df5raw = pd.read_excel("2023_10_10_Filter_5.xlsx", engine = "openpyxl", skiprows = 1)
df6raw = pd.read_excel("2023_10_10_Filter_6.xlsx", engine = "openpyxl", skiprows = 1)
df2 = np.array(df2raw)
df4 = np.array(df4raw)
df5 = np.array(df5raw)
df6 = np.array(df6raw)
